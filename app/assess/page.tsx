...
const MARISOL_EXAMPLE =
  "I live in Jersey City with my two kids, ages 5 and 8. My hours at work just got cut and money is really tight. I just got a notice that my electricity will be shut off next week, and our fridge is almost empty. I don't know where to start or what help I can get.";
      ...
      <div className="space-y-6">
        {messages.map((m) => {
          ...
          const planPart = parts.find(
            (p) => p.type === "tool-present_action_plan",
          );
          ...
          return (
            <div key={m.id} className="space-y-4">
              ...
              {planPart &&
              (planPart.state === "input-available" ||
                planPart.state === "output-available") &&
              planPart.input ? (
                <ActionPlanView plan={planPart.input as ActionPlan} />
              ) : null}
            </div>
          );
        })}
